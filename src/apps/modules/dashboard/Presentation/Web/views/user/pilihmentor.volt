...
{% block navbarCont %}
    ...
    <div class="text-center" style="width: 100%; background-color: white; border-top: 2px solid #26405B; padding-top: 3%;">
        <h2 style="color: #26405B;" id="mentor">Mentor</h2>
        <p class="text-center" style="margin-top: 2%;">Anda dapat memilih mentor terbaik dengan beragam pengalaman</p>
        <div class="d-flex justify-content-center text-center" style="color: #26405B; width: 100%; margin-top: 3%; flex-wrap: wrap;">
            {% for mentor in mentors %}
            <div style="margin-top: 4%; flex: 0 0 33.33%; padding-bottom: 2%;">
